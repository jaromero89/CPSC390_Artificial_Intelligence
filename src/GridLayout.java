...
public class GridLayout {
    ...
    public GridLayout(String fileName) {
        try {
    ...
    public static char[][] designGridFromFile(String fileName) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                if (i == 0) {
                    ...
                    grid = new char[ArraySize][ArraySize];
                    ++i;
                } else {
            ...
            System.err.println("Error opening: " + fileName + "Try again!");
            e.printStackTrace();
        }
        return grid;
    }

    public static void DisplayGrid( char[][] nXn) {
